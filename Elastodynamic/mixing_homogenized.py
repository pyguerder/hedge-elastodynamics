...
simulation(write_output=['vtu', 'receivers'],
           ...
           flux_type="lf",
           max_steps=1e6,
           output_dir='Mixing2D_rand_heterogeneous_5e4_cuda_eff_40Hz',
           pml=[5, 0, 0, 5, 0, 0],
           ...
           material_files = ['Materials/polymer_in_PDMS_homogenized.dat', 'Materials/polymer_in_PDMS_homogenized.dat'],
           vtu_every=1000)
